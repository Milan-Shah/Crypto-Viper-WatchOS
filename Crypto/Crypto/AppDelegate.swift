...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Getting Crypto List View module
        let cryptoList = ListRouter.createModule()
        
        // Instantiating instance of UINavigationController with Crypto List View module
        let cryptoNav = UINavigationController()
        cryptoNav.viewControllers = [cryptoList]
        ...
        window?.rootViewController = cryptoNav
